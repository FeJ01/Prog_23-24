import Calcolo_Aqi as caqi
import Studio_Feature as fs
from Supervisionato import init
from Supervisionato import KNNRegressor as kn
from Supervisionato import LinearRegression as lr
from Supervisionato import RandomForest as rf
from Supervisionato import ValutazioneModello as evm
from Non_supervisionato import KMeans as kms
from Bayesiano import BayesianNetwork as bn
...
def main():
    ...
    print("***Calcolo dell'AQI e generazione del nuovo dataset global_air01.csv***")
    original_df= pd.read_csv(r"global_air.csv")
    ...
    kb.create_kb(df_New)
    kb.rule_definition()
    kb.create_csv(r"global_air02.csv","global_air_fin.csv")

    df_final = pd.read_csv(r"global_air_fin.csv")
